...
public class SpecificBlockFetchingStrategy implements DataFetchingStrategy {
    ...
    public EthereumRpcService.EthBlockResponse fetchData(String blockNumber) {
        EthereumRpcService.EthBlockResponse response = webClient.post()
                .bodyValue(new EthereumRpcService.EthRequest("2.0", "eth_getBlockByNumber", List.of(blockNumber, true), 1))
                .retrieve()
